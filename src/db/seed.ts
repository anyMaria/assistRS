...
const defaultColorRules = [
  ...
  { entity: "idees", field: "status", operator: "egal", value: "publiee", color: "#17B26A", label: "Publiée" },
  { entity: "publications", field: "deadline", operator: "inferieur", value: "0", color: "#E5484D", label: "Deadline dépassée" },
  { entity: "publications", field: "deadline", operator: "inferieur", value: "2", color: "#F5A524", label: "Deadline proche (moins de 2 jours)" },
  { entity: "publications", field: "status", operator: "egal", value: "publiee", color: "#17B26A", label: "Publiée" },
];
